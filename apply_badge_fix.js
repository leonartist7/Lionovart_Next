...
const regex = /function TrustBadge[\s\S]*?(?=\/\* "?"?"? Main Component)/;
  ...
  return (
    ...
    >
       ...
       <img 
         ...
         alt="" 
         className="absolute left-0 bottom-[8%] h-[82%] w-[48%] object-contain object-left-bottom pointer-events-none" 
       />
       {/* Right Laurel (Flipped) */}
       <img 
         src="/images/laurel.webp" 
         alt="" 
         className="absolute right-0 bottom-[8%] h-[82%] w-[48%] object-contain object-right-bottom pointer-events-none scale-x-[-1]" 
       />
