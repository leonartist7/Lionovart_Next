...
import {journeyPose,journeyProgress,journeyRoute,routePoint} from '../src/components/sections/lion-journey/motion.ts';
function fixture(w) {
...
test('layout refresh extends stream through translated content without stale endpoints',()=>{
