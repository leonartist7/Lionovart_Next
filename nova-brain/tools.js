const { Type, Behavior } = require("@google/genai");
        ...
        parameters: {
          ...
          properties: {
            ...
            key: {
              type: Type.STRING,
              description:
                "Specific key within the kind — e.g. 'restaurant' for kind='niche', 'branding' for kind='service', 'pricing' for kind='faq'. Omit for philosophy / value_bomb / call_offer.",
            },
          },
          required: ["kind"],
        },
        ...
        parameters: {
          ...
          properties: {
            timezone: {
              type: Type.STRING,
              description:
                "IANA timezone if the user mentioned one (e.g. 'America/Edmonton'). Omit if unknown — never ask for it explicitly, infer or omit.",
            },
          },
        },
      },
        ...
        parameters: {
          ...
          properties: {
            ...
            booking_url: {
              type: Type.STRING,
              description:
                "The booking page URL (link mode), or the confirmed booking's view link (calcom mode, from book_meeting's manage_url)",
            },
            summary_message: {
              type: Type.STRING,
...
module.exports = { STRATEGIST_TOOLS };
