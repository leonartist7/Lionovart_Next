...
const GradientSvg: React.FC<GradientSvgProps> = ({ className, isHovered, colors }) => {
  ...
  const variants = {
    hovered: {
      ...
      transition: { duration: 150, repeat: Number.POSITIVE_INFINITY, ease: 'linear' as const },
    },
    notHovered: {
      gradientTransform: gradientTransform,
      transition: { duration: 90, repeat: Number.POSITIVE_INFINITY, ease: 'linear' as const },
    },
  };
