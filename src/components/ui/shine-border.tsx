...
/**
 * @name Shine Border
 * @description Animated shining border effect. Wraps children in a card whose
 * border sweeps through `color` on a `duration`-second loop.
 */
