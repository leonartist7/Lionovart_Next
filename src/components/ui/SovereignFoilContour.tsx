...
export const SovereignFoilContour = memo(function SovereignFoilContour({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-[clamp(4px,0.6vw,6px)] z-[2] rounded-[16px] bg-white shadow-[inset_0_1px_0_rgba(255,255,255,0.95),inset_0_0_0_1px_rgba(112,74,0,0.12)] md:rounded-[18px]" />
    </div>
  );
});
