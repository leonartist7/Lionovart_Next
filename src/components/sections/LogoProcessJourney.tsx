...
function MobileJourney({
  ...
  return (
    <div className="relative overflow-hidden bg-[#090909] px-5 pb-24 pt-24 sm:px-7 lg:hidden">
      <div className="pointer-events-none absolute -right-[32vw] top-20 w-[108vw] max-w-[620px] opacity-[0.055]">
        <GoldOutlineMark className="h-auto w-full" />
      </div>
      ...
      <div className="relative mx-auto max-w-xl">
          ...
          <div className="space-y-16">
            {STAGES.map((stage, index) => (
              ...
              >
                ...
                />
                <p className="font-body text-[9px] font-bold uppercase tracking-[0.22em] text-[#c7a86a]/62">
                ...
                <p className="mt-4 font-body text-[9px] uppercase tracking-[0.16em] text-[#c7a86a]/52">
                  {stage.micro}
                </p>
              </motion.article>
            ))}
        ...
        <motion.div
          ...
          className="mx-auto mt-20 w-[min(60vw,260px)]"
        >
        ...
        <div className="mt-10 text-center">
          ...
          <p className="mt-4 font-body text-[12px] text-white/38">{ctaSub}</p>
        </div>
      </div>
    </div>
  );
...
export default function LogoProcessJourney(props: any) {
  ...
  // This prevents camera drift, overlapping layouts and the "floating logo" feel.
      ...
      >
        ...
        <div className="relative z-20 mx-auto grid h-full max-w-[1500px] grid-cols-[minmax(0,0.96fr)_minmax(430px,0.78fr)] gap-[clamp(3rem,7vw,8rem)] px-[clamp(3rem,7vw,7rem)]">
          <div className="relative flex h-full min-w-0 flex-col">
            <header className="pt-[clamp(4rem,9vh,7rem)]">
              <div className="flex items-center gap-4">
                ...
                <p className="font-body text-[10px] font-bold uppercase tracking-[0.3em] text-[#c7a86a]/68 xl:text-[11px]">
                  {eyebrow}
                </p>
              </div>
              ...
              <p className="mt-6 max-w-[38ch] font-body text-[13px] leading-[1.7] text-white/42 xl:text-[14px]">
            ...
            <div className="mb-[clamp(3.5rem,9vh,7rem)] mt-auto max-w-[660px]">
              <div className="min-h-[220px]" aria-live="polite">
                <AnimatePresence mode="wait" initial={false}>
                  ...
                  >
                    <div className="flex items-center gap-3 font-body text-[9px] font-bold uppercase tracking-[0.24em] text-[#c7a86a]/66">
                      <span>{String(shownStage + 1).padStart(2, "0")}</span>
                      <span className="h-px w-7 bg-[#c7a86a]/38" />
                      <span>04</span>
                    </div>
                    ...
                    <p className="mt-4 max-w-[44ch] font-body text-[13px] leading-[1.7] text-white/48 xl:text-[14px]">
                      {activeCopy}
                    </p>
                    <p className="mt-5 font-body text-[9px] uppercase tracking-[0.19em] text-[#c7a86a]/48">
                      {active.micro}
                    </p>
                    ...
                    {shownStage === 3 ? (
                      <div className="mt-7 flex items-center gap-5">
                        ...
                        <span className="font-body text-[11px] text-white/28">{ctaSub}</span>
                      </div>
                    ) : null}
                  </motion.div>
                </AnimatePresence>
              ...
              <div className="mt-8 border-t border-white/[0.09] pt-4">
                <div className="grid grid-cols-4 gap-4">
                  {STAGES.map((stage, index) => {
                    ...
                    return (
                      <div key={stage.name} className={current ? "opacity-100" : "opacity-28"}>
                        <p className="font-body text-[8px] font-bold tracking-[0.18em] text-[#c7a86a]">
                          {String(index + 1).padStart(2, "0")}
                        </p>
                        <p className="mt-1 truncate font-body text-[8px] font-bold uppercase tracking-[0.12em] text-white">
                          {stage.name}
                        </p>
                      </div>
                    );
                ...
                <div className="mt-4 h-px overflow-hidden bg-white/[0.08]">
                  <motion.div
                    className="h-full origin-left bg-[#c7a86a]/72"
          ...
          <div className="relative flex h-full items-center justify-center">
            <div className="relative w-[min(34vw,500px)] translate-y-[2vh]">
              <div
                aria-hidden="true"
              ...
              <div className="mt-7 flex items-center justify-center gap-3 font-body text-[8px] uppercase tracking-[0.22em] text-white/22">
                <span>Clarity</span>
                <span className="h-px w-8 bg-[#c7a86a]/28" />
                <span>Direction</span>
                <span className="h-px w-8 bg-[#c7a86a]/28" />
                <span>Growth</span>
              </div>
