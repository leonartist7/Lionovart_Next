  ...
  [
    {
      ...
      quote:
        "Sold more cars off the new site in one quarter than I did all last year online. The difference is the people calling already know what they want.",
    ...
    },
    {
      ...
      quote: "Same traffic as before, about double the checkouts. Nothing else changed.",
    ...
    },
    {
      ...
      quote: "The site finally looks the way the clothes feel. Sounds like a small thing. It wasn't.",
    ...
    },
    {
      ...
      quote: "People stopped asking whether we were a real company. Sales went up, returns went down.",
    ...
    },
    {
      ...
      quote: "New site, new ads, all of it. Showroom appointments doubled in two months.",
    ...
    },
    {
      ...
      quote:
        "The site had to feel like the houses we sell. Quiet, never shouting. They understood that on the first call.",
    ...
    },
    {
      ...
      quote:
        "We had beautiful pieces and packaging that let them down. They closed the gap between the two.",
    ...
    },
    {
      ...
      quote: "Patients arrive already trusting us. That never used to happen.",
    ...
    },
    {
      ...
      quote: "For years I couldn't explain what I actually do. Now I hand my card over without apologising for it.",
  ...
  [
    {
      ...
      name: "Miller & Carter",
      role: "Steakhouse · UK",
      quote: "Brand and booking rebuilt together, which mattered more than we expected. Weekends are a different business now.",
    ...
    },
    {
      ...
      quote: "We've been booked three weeks out since the new site went live.",
    ...
    },
    {
      ...
      quote: "People walk in and mention the logo before they mention the flowers. I did not expect that.",
    ...
    },
    {
      ...
      quote: "The portfolio finally looks like the work deserves. I stopped losing jobs at the link.",
    ...
    },
    {
      ...
      quote: "Travellers book and pay before they land now. I run this on my own, so that is my evenings back.",
    ...
    },
    {
      ...
      quote:
        "Direct bookings are up since the rebuild. Every one of them is margin we used to hand straight to the platforms.",
    ...
    },
    {
      ...
      quote:
        "Investors kept telling us the brand looked early. They rebuilt the page and the identity, and we closed the seed six weeks later.",
    ...
    },
    {
      ...
      quote: "People photograph the cups before they drink from them. That does more than any ad I ever paid for.",
    ...
    },
    {
      ...
      quote: "My workshop finally has a name and a look that match what I make. I send people to the site now instead of my Instagram.",
