...
export default function Footer({ variant = "standard" }: { variant?: FooterVariant }) {
  ...
  return (
    <footer
      ...
      className={`relative z-0 isolate overflow-hidden bg-[#e5192a] ${isCurtain ? "sticky bottom-0" : ""}`}
    >
      ...
      >
        <p className="whitespace-nowrap text-[10px] uppercase tracking-[0.08em] text-white/90 sm:text-[11px]">
        ...
        >
          <Link
            href="/privacy"
            className="text-white/90 transition-colors duration-200 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-brand-red"
          >
            {t.footer.privacy}
          </Link>
          <Link
