...
export default function ProblemsSolvedSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-bg-dark py-12 lg:py-24">
          ...
          {items.map((item, i) => {
            ...
            return (
              <div 
                ...
                className="relative w-full overflow-hidden rounded-[16px] md:rounded-[20px] border border-white/10 cursor-pointer group hover:border-brand-gold/30 transition-colors"
              ...
              {/* --- PROBLEM LAYER (OVERLAY) --- */}
              <div 
                className={`absolute inset-0 z-10 w-full h-full bg-bg-brand-black p-5 md:p-8 flex flex-col justify-center transition-transform duration-[600ms] ease-[cubic-bezier(0.25,0.1,0.25,1)] ${
                  isCardRevealed ? "translate-y-[101%]" : "translate-y-0"
                }`}
              >
                <div className="flex items-start md:items-center gap-3 mb-2 relative z-20">
                ...
                <p className="text-text-muted font-sans text-[13px] md:text-[15px] leading-[1.6] relative z-20">
                  {item.problem.body}
                </p>

                {/* Local Paw Animation */}
                <div 
                  className={`pointer-events-none absolute z-0 transition-all duration-[700ms] ease-[cubic-bezier(0.25,0.1,0.25,1)] ${
                    isCardRevealed 
                      ? "top-[120%] left-[120%] rotate-[60deg] opacity-100" 
                      : "top-[-80%] left-[-50%] rotate-[-45deg] opacity-0"
                  }`}
                >
                  <div className="relative w-[240px] h-[240px] md:w-[320px] md:h-[320px] drop-shadow-[0_0_20px_rgba(240,201,23,0.3)]">
                    <Image 
