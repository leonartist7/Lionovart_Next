  ...
  return (
    ...
    >
      ...
      {goldHorizon && (
        ...
        >
          <div className="absolute inset-x-0 bottom-[-65%] h-[165%] bg-[radial-gradient(ellipse_42%_100%_at_50%_100%,rgba(240,201,23,0.42)_0%,rgba(240,201,23,0.12)_42%,transparent_74%)]" />
