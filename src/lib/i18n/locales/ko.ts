...
export const ko: Translations = {
  ...
  comparison: {
    ...
    competitors: [
      {
        title: "인하우스 팀",
        description: "채용에는 시간이 걸리고, 교체는 느리며, 급여는 쌓입니다 — 특히 필요가 변동될 때 더욱 그렇습니다.",
        cells: [
          "인원 수에 묶임",
          "채용 후에는 유연함",
          "인력이 갖춰지면 일정함",
      ...
      {
        title: "크리에이티브 에이전시",
        description: "전략적 파트너이지만, 높은 고정 비용과 경직된 범위, 느린 일정 탓에 일상적인 협업에는 잘 맞지 않습니다.",
        cells: [
          "1~2주 소요",
          "범위가 고정됨",
          "완성도는 높음",
      ...
      {
        title: "프리랜서",
        description: "복불복입니다. 프로젝트마다 인재를 찾고 관리하다 보면 브랜드를 키우는 대신 일관성을 쫓게 됩니다.",
        cells: [
          "상대 일정에 달림",
          "프로젝트별로 유연함",
          "누구를 쓰냐에 따라 다름",
      ...
      {
        title: "AI 도구만 사용",
        description: "쓰기엔 빠르지만, 결과물은 브랜드와 동떨어지고 일관성이 없어 마무리에 많은 수작업이 필요합니다.",
        cells: [
          "즉시 결과물 생성",
          "프롬프트에 갇힘",
          "브랜드와 동떨어진 결과",
